 ...
 */
public class PlatformPlateHalf extends DeviceBase implements ILightSource {

    public static final int ALIGN_CENTER = 0, ALIGN_LEFT = 1, ALIGN_RIGHT = 2;

    public static class TileEntityPlatformPlateHalf extends TileEntityPlatformPlate {

        public TileEntityPlatformPlateHalf() {
            setInfo(12, 1, 0.5, 0.5);
        }
        ...
        public void updateSignal(World world, BlockPos pos) {
            ...
            if (tileEntity instanceof TileEntityPlatformPlateHalf) {
                TileEntityPlatformPlateHalf light = (TileEntityPlatformPlateHalf) tileEntity;
    ...
    public TileEntity createNewTileEntity() {
        return new TileEntityPlatformPlateHalf();
    }

    public PlatformPlateHalf() {
        super(Material.GLASS, "PlatformPlateHalf");
        setRegistryName(NyaSamaOptics.MODID, "platform_plate_half");
        setLightLevel(0);
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)  {
        TileEntity tileEntity = world.getTileEntity(pos);
        if (tileEntity instanceof TileEntityPlatformPlateHalf) {
            TileEntityPlatformPlateHalf text = (TileEntityPlatformPlateHalf) tileEntity;
            if (!world.isRemote) {
