 ...
 */
public class AdBoardRenderer extends AbsTileEntitySpecialRenderer {

    private final WavefrontObject modelShell = new WavefrontObject(
            new ResourceLocation("nyasamaoptics", "models/blocks/" + "ad_board" + "_base.obj")
    );
    private final WavefrontObject modelLight = new WavefrontObject(
            new ResourceLocation("nyasamaoptics", "models/blocks/" + "ad_board" + "_light.obj")
    );
